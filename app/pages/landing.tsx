...
export function Landing() {
  return (
    <div className="h-screen">
      <Header />
      <main className="mx-12 text-black">
        ...
        <section className="md:mb-80 mb-32">
          ...
          <div className="flex justify-center mt-8 gap-4">
            <button className="bg-black text-white rounded-md px-4 py-3">Get Started</button>
            <button className="px-4 py-3 border-neutral-300 border rounded-md">Learn More</button>
          </div>
        </section>
